...
REGISTRO_SKILLS = {
    ...
    "civil3d_to_revit_toposolid": {
        ...
        "script": os.path.join(BASE_DIR, "migracion", "scripts", "Dynamo_CreateToposolids_ConHuecos.py"),
        "doc": os.path.join(BASE_DIR, "migracion", "civil3d-to-revit-toposolid.skill.md"),
    },
    "marcas_pavimentacion_a_revit": {
        "nombre": "Marcas de pavimentación y objetos discretos a Revit (Familia/DirectShape)",
        "categoria": "Migración",
        "palabras_clave": ["marcas viales", "marcas de pavimentacion", "new jersey", "barrera",
                           "directshape", "polyfacemesh", "familia parametrica", "tessellatedshapebuilder",
                           "señalizacion", "mobiliario urbano", "flecha de pavimento", "stopbar",
                           "pieza enterrada", "z-fighting", "intersectwithcurve", "grilla uv"],
        "script": os.path.join(BASE_DIR, "migracion", "scripts", "exportar_marcas_pavimento.py"),
        "doc": os.path.join(BASE_DIR, "migracion", "marcas-pavimentacion-a-revit.skill.md"),
    },
